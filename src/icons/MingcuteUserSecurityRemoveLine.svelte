<script lang="ts" module>
	export interface MingcuteUserSecurityLineProps {
		size?: number;
		class?: string;
	}
</script>
...
<script lang="ts">
	const { size = 0.7, class: className = '' }: MingcuteUserSecurityLineProps = $props();
</script>
