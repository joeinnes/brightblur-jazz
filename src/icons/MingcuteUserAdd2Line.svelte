<script lang="ts" module>
  export interface MingcuteUserAdd2LineProps {
    size?: number;
    class?: string;
  }
</script>
...
<script lang="ts">
  const { size = 0.7, class: className = '' }: MingcuteUserAdd2LineProps = $props();
</script>
