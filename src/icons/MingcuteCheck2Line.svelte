<script lang="ts" module>
  export interface MingcuteCheck2LineProps {
    size?: number;
    class?: string;
  }
</script>
...
<script lang="ts">
  const { size = 0.7, class: className = '' }: MingcuteCheck2LineProps = $props();
</script>
