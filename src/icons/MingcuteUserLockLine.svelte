<script lang="ts" module>
  export interface MingcuteUserLockLineProps {
    size?: number;
    class?: string;
  }
</script>
...
<script lang="ts">
  const { size = 0.7, class: className = '' }: MingcuteUserLockLineProps = $props();
</script>
