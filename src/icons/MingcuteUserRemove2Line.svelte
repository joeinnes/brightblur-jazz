<script lang="ts" module>
  export interface MingcuteUserRemove2LineProps {
    size?: number;
    class?: string;
  }
</script>
...
<script lang="ts">
  const { size = 0.7, class: className = '' }: MingcuteUserRemove2LineProps = $props();
</script>
